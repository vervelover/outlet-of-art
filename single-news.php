<?php
/**
 * This file controls the Single News Template
 *
...
add_action('genesis_before_entry_content', 'ap_luogo_evento');
function ap_luogo_evento() {
	if (get_field('link_luogo')) {
		echo '<p><a href="' . get_field('link_luogo') . '" target="_blank">';
		echo get_field('luogo');
		echo '</a></p>';
	} else {
		echo '<p>' . get_field('luogo') . '</p>';
	}
	echo '<hr>';
}
